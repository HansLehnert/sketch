...
int main(int argc, char* argv[]) {
    ...
    // Parse data set
    std::vector<unsigned long> data_vectors = parseFasta(argv[1], 16);

    std::cout << "Parse time: " << std::chrono::duration<double>(std::chrono::steady_clock::now() - start).count() << " s" << std::endl;
